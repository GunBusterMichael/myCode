...
// 将 Vue 实例需要使用到的组件 Cpn 引入到 Vue 实例模板的 .vue 文件中。
...
console.log((0, _mathUtils.add)(20, 30)); // 1.1 使用 ES6 的模块化规范
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("p", [_vm._v("我是 Cpn 组建的内容哦哦哦哦哦哦哦")]),
    _vm._v(" "),
